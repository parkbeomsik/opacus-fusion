...
for experiment in experiments:
    ...
    return_code = 0
    while return_code == 0:
        args = f"nice -n 10 taskset -c 0-20 python benchmark.py --steps 20 --input_size {input_size} --architecture {architecture} --model_type {model_type} --dpsgd_mode {algo} --grad_sample_mode {grad_sample_mode} --batch_size {batch_size}"
